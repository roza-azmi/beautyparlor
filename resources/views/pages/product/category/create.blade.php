...
<form action="{{route('category.store')}}" method="POST">
  ...
  <div class="form-group">
    ...
    <input name="service_name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter category name">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">price</label>
    <input name="price" type="number" class="form-control" id="exampleInputPassword1" placeholder="Details">
  </div>
...
<h2 class="heading-section">service table </h2>
</div>
</div>
<div class="row">
<div class="col-md-12">
<h4 class="text-center mb-4">service list  </h4>
